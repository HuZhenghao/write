  ...
  onShareAppMessage: function () {
    ...
    if (that.data.navigation_type === "custom") {
      if (this.data.lesson_id === 0 || this.data.lesson_id === null) {
        ...
        return {
          title: 'Rays听写',
          path: '/pages/desktop/desktop=' + '&adviser_id=' + adviser_id
        }
      } else {
        //我的自定义列表的单元页
        return {
          title: this.data.lesson_name,
          path: '/pages/unit/unit?navigation_type=' + this.data.navigation_type + '&lesson_id=' + this.data.lesson_id + '&adviser_id=' + adviser_id + '&share=true'
        }
      }
      ...
      return {
        ...
        path: '/pages/unit/unit?navigation_type=' + that.data.navigation_type + '&lesson_id=' + that.data.lesson_id + '&share=true' + '&book_id=' + that.data.book_id + '&bookname=' + that.data.book_name + '&lesson_name=' + that.data.lesson_name + '&adviser_id=' + adviser_id
      }
