...
Page({
  ...
  onLoad: function (options) {
    ...
    // var ap = this.data.dataCode
    // var appid1 = this.toArr(ap)[0];
    // // console.log(iiid)
    // var exer = this.toArr(ap)[1]
    // var isbn1 = this.toArr(exer)[0]
    // var uid1 = this.toArr(exer)[1]
    // //console.log(this.toArr(exer))
    // // console.log('appid=' + exer )
    // console.log('isbn1=' + isbn1)
    // this.setData({ ISBN: isbn1 })
    // console.log(this.data.ISBN)
    // if (this.data.ISBN !== 0) {
    //   this.fromCodeBook(this.data.ISBN)
    // }
